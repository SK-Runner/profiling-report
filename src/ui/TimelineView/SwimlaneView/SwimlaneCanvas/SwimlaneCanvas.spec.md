...
27. **PR-CANVAS-027** — Shift+drag past 4px draws the marquee and commits intersecting events.
28. **PR-CANVAS-028** — a marquee hitting nothing commits an empty selection.
29. **PR-CANVAS-029** — marquee suppresses pan/tooltip/select; `pointerleave` does not cancel.
30. **PR-CANVAS-030** — Escape during the marquee drag cancels without committing.
31. **PR-CANVAS-031** — plain (no-Shift) drag still pans and never marquees.
...
## Changelog
- **2026-08-25** — Shift+drag marquee multi-select; `multi-select` emit + `multiSelectedIds` prop; PR-CANVAS-027…031.
